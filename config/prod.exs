...
config :tasktrack3, Tasktrack3Web.Endpoint,
  ...
  https: [port: 443,
          otp_app: :tasktrack3,
          keyfile: System.get_env("priv/zombo.club.key"),
          certfile: System.get_env("priv/zombo.club.cert"),],
...
# start per endpoint:
#
#     config :tasktrack3, Tasktrack3Web.Endpoint, server: true
#
...
config :tasktrack2, Tasktrack3Web.Endpoint,
